...
public class UserDataProviderTest {
    private JDBCConnector jdbcConnector = new JDBCConnector("com.mysql.jdbc.Driver", "jdbc:mysql://localhost/jdbc_database", "root", "123123");
    ...
    public void getFirstUser() throws NoConnectionException {
        ...
        List actual = userDataProvider.getAllRecord("users", User.class);
    ...
    @Test
    public void getUser() throws NoConnectionException {
        UserDataProvider userDataProvider = new UserDataProvider(jdbcConnector.getConnection(), new LinkedList());
