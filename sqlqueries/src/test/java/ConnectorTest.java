...
import com.clouway.jdbcqueries.NoConnectionException;
...
public class ConnectorTest {
    ...
    public void getConnector() throws NoConnectionException {
        Connector connector = new Connector("com.mysql.jdbc.Driver", "jdbc:mysql://localhost/jdbc_database", "root", "clouway.com");
